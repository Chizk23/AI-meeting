...
from src.api.domains.meetings.support import estimate_segment_end, normalize_speaker_label
...
async def finalize_meeting_transcript(
    ...
    if persist_transcript:
        try:
            from src.api.domains.meetings.operations import AUDIO_UPLOAD_DIR, LEGACY_AUDIO_UPLOAD_DIR
