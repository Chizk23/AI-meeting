...
const SystemAdminConsole = React.lazy(() => import('./features/admin/pages/SystemAdminConsole'));
const AdminOrganizations = React.lazy(
  () => import('./features/admin/components/AdminOrganizations'),
);
const AdminUsers = React.lazy(() => import('./features/admin/components/AdminUsers'));
const AdminAIServices = React.lazy(() => import('./features/admin/components/AdminAIServices'));
const AdminPrompts = React.lazy(() => import('./features/admin/components/AdminPrompts'));
